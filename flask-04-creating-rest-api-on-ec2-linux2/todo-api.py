...
def insert_task(title, description):
    insert = f"""
    INSERT INTO todos (titie, description)
...
# Write a function named `home` which returns 'Welcome to the Zylina's To-Do API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Zylina's To-Do API Service"
